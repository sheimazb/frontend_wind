  ...
  template: `
    <div class="relative bg-[#362C45] text-white rounded-lg overflow-visible">
      ...
      <div class="pt-16 px-8 pb-8">
        ...
        <div class="space-y-2">
          <p class="text-white/70 text-center text-sm">Enter your verification code and new password.</p>
        </div>
          ...
          <div>
            ...
            <div class="flex gap-2 justify-center">
              <input *ngFor="let i of [0,1,2,3,4,5]" 
                     ...
                     maxlength="1"
                     class="h-11 w-11 rounded-lg bg-[#111036]/50 border border-white/10 text-white text-center text-lg font-bold focus:border-[#E1567C] focus:outline-none focus:ring-2 focus:ring-[#E1567C]/20 transition-all"
          ...
          <div>
            ...
            <div class="relative">
              <input
                ...
                class="w-full h-11 px-4 rounded-lg bg-[#111036]/50 border border-white/10 text-white placeholder:text-white/30 focus:border-[#E1567C] focus:outline-none focus:ring-2 focus:ring-[#E1567C]/20 transition-all text-sm"
              />
